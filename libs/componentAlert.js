/* Requiere jquery => 3 */
let componetZ = '<div style="z-index: 10;display: none;opacity: 0.95;width: 300px;min-height: 50px;height:auto;padding: 20px;border-radius: 15px;overflow: hidden;background-color: #d4edda;position:fixed;top: 20px;left:79%" id="boxAlert"></div>';
$('body').prepend(`${componetZ}`);
